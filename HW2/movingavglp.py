...
axs[2,0].plot(dataA,'black',label='Unfiltered')
axs[2,0].plot(movavgA,'red',label='Filtered')
axs[2,0].set_title('SigA Comparison - Moving Average')
axs[2,0].legend()

axs[2,1].plot(dataB,'black',label='Unfiltered')
axs[2,1].plot(movavgB,'red',label='Filtered')
axs[2,1].set_title('SigB Comparison - Moving Average')
axs[2,1].legend()

axs[3,0].plot(dataC,'black',label='Unfiltered')
axs[3,0].plot(movavgC,'red',label='Filtered')
axs[3,0].set_title('SigC Comparison - Moving Average')
axs[3,0].legend()

axs[3,1].plot(dataD,'black',label='Unfiltered')
axs[3,1].plot(movavgD,'red',label='Filtered')
axs[3,1].set_title('SigD Comparison - Moving Average')
axs[3,1].legend()
