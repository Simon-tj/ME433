...
axs[2,0].plot(iirA,'red',label='Filtered')
axs[2,0].set_title('SigA Comparison - IIR Filter')
axs[2,0].legend()

axs[2,1].plot(dataB,'black',label='Unfiltered')
axs[2,1].plot(iirB,'red',label='Filtered')
axs[2,1].set_title('SigB Comparison - IIR Filter')
axs[2,1].legend()

axs[3,0].plot(dataC,'black',label='Unfiltered')
axs[3,0].plot(iirC,'red',label='Filtered')
axs[3,0].set_title('SigC Comparison - IIR Filter')
axs[3,0].legend()

axs[3,1].plot(dataD,'black',label='Unfiltered')
axs[3,1].plot(iirD,'red',label='Filtered')
axs[3,1].set_title('SigD Comparison - IIR Filter')
axs[3,1].legend()
