...
axs[2,0].plot(firA,'red',label='Filtered')
axs[2,0].set_title('SigA Comparison - FIR Filter')
axs[2,0].legend()

axs[2,1].plot(dataB,'black',label='Unfiltered')
axs[2,1].plot(firB,'red',label='Filtered')
axs[2,1].set_title('SigB Comparison - FIR Filter')
axs[2,1].legend()

axs[3,0].plot(dataC,'black',label='Unfiltered')
axs[3,0].plot(firC,'red',label='Filtered')
axs[3,0].set_title('SigC Comparison - FIR Filter')
axs[3,0].legend()

axs[3,1].plot(dataD,'black',label='Unfiltered')
axs[3,1].plot(firD,'red',label='Filtered')
axs[3,1].set_title('SigD Comparison - FIR Filter')
axs[3,1].legend()
