...
void LCD_drawChar(unsigned short xstart, unsigned short ystart, unsigned short color, unsigned char letter) {
    ...
    for (i=0;i<5;i++)
    {
        for(j=0;j<8;j++)
        {
            ...
            {
                LCD_drawPixel(xstart,ystart,BLACK);
            }
            ystart+=1;
        }
        xstart+=1;
...
void LCD_drawHProgressBar(unsigned short xstart, unsigned short ystart, unsigned short xend, unsigned short color)
{
    int i = 0;
    int j = 0;
    unsigned short ystartinit = ystart;
...
void LCD_drawVProgressBar(unsigned short xstart, unsigned short ystart, unsigned short yend, unsigned short color)
{
    int i = 0;
    int j = 0;
    unsigned short xstartinit = xstart;
    for (i=0;i<(yend);i++)
    {
        for(j=0;j<8;j++)
        {
